...
if(isset($_POST['save'])){
  ...
  $sql = "INSERT INTO applicant_info (firstname, middlename, lastname, birthplace, birthdate, age, gender, email, phone, civil_status, 
  ...
  '$bplace', '$bdate ','$age','$gender','$email','$phone',
